...
class MaddPrf extends StatefulWidget {
  const MaddPrf({super.key});

  @override
  State<MaddPrf> createState() => _MaddPrfState();
}

class _MaddPrfState extends State<MaddPrf> {
  ...
  Future<void> inscription(String nom, String prenom, String cin, String date,
    ...
    try {
      ...
      await FirebaseFirestore.instance.collection('Professeur').doc(prid).set({
        'nom': nom,
        'prenom': prenom,
        'cin': cin,
        'date naisance': date,
